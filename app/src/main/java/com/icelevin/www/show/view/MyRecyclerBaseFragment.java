...
import com.hb.utils.view.recycler.TipsFragment;

/**
 * Created by ice on 2017/12/13.
 */

public abstract class MyRecyclerBaseFragment extends BaseFragment {
    protected ParmBean parametersBean = new ParmBean();
...
//                    parametersBean.setCurPage(loadPage);
                ...
                case MSG_UI_LOAD_FAILE:
                    ...
                    if (!TextUtils.isEmpty(loadPage) || !tipFragment.isShow()) {
...
//                        parametersBean.setCurPage(loadPage);
                ...
                case MSG_UI_LOAD_NO_DATA:
                    ...
                    // 数据加载成功,但数据条数为0
//                    loadPage = parametersBean.getCurPage();
                    if (TextUtils.isEmpty(parametersBean.getCurPage())  && isShowNullPage) {
...
//                    loadPage = parametersBean.getCurPage();
    ...
    protected void initView() {
        ...
        tipFragment = (TipsFragment) getChildFragmentManager().findFragmentById(com.hb.utils.R.id.tip_parent);
        if (tipFragment == null) {
            tipFragment = new TipsFragment();
            getChildFragmentManager().beginTransaction().add(com.hb.utils.R.id.tip_parent, tipFragment).commit();
        }
    }
...
//        loadPage = 1;
        loadPage="";
        parametersBean.setHasNextPage(false);
